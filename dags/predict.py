...
from dags.config import GENERATED_DATA_PATH, DATA_FOLDER, MODEL_REGISTRY_FOLDER, MODEL_PATH, PREDICTIONS_FOLDER
...
def predict():
    ...
    @task
    def predict_with_io_task(features_path: str) -> None:
